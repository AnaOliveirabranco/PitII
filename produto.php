...
<section class="py-5">
    ...
    <?php
$query = "SELECT idProd, nome, imagem, valor, descricao FROM tbproduto WHERE idProd = '".$_GET['id']."' ";
...
?>
        ...
        <div class="row">
            <div class="col-md-6 produtosn" style="background-image: url('assets/img/produtos/<?php echo $imagem; ?>');">
      <img class="img-fluid imagempng invisible" src="assets/img/produtos/box.png" loading = "lazy" alt="">
            </div> <!-- fim col -->

<div class="col-md-6">

<h1 class="text-marrom text-uppercase font-weight-light" > <?php echo $nome; ?></h1>
<h3 class="text-white"> R$ <?php  echo  $valor;   ?></h3>

<p class="text-white py-3" style="border-top: 1px solid #f3a84d;border-bottom: 1px solid #f3a84d;">
<?php echo $descricao;?>
</p>


<!-- <a href="carrinho.php?idPro=??&IdUser" class="btn btn-warning  text-uppercase text-white">Comprar</a> -->
<a   href="carrinho.php?prod=<?php  echo $id?>" id="comprar" class="btn btn-warning  text-uppercase text-white">Comprar</a>
