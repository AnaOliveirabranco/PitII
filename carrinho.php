...
<section class="py-5">
    <div class="container">
      ...
      <div class="row">
              <div class="col-md-12">
                <h3 class="text-white"> Seus Produtos </h3>
              </div> <!-- fim col -->
      </div> <!-- fim row -->
  <div class="row">
          <div class="col-md-12">
...
<?php  }  ?>
  ...
  <div class="row ">
          <div class="col-md-12 d-flex justify-content-end align-items-end flex-column">
<p class="text-white" >Todos os pedidos deveram ser pagos no recebimento    </p>

    <a href="obrigado.php?idprod=<?php echo $idprod;?>&valor=<?php echo $idprod;?>" class="btn btn-warning text-white" id='finalizar'>Finalizar compra </a>
          </div> <!-- fim col -->
  </div> <!-- fim row -->
